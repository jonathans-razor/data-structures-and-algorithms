...
// Example usage:
const inputArray = process.argv.slice(2).map(Number);
const targetValue = inputArray.pop(); // Last argument is the target value
const result = search(inputArray, targetValue);
